...
d===!0?(c.lock(a),typeof b==="function"&&b(a),!0):!1},end:function(a){c.unlock(a);return c.destroyLock(a)},save:function(a,b){return e[a]=b},destroy:function(a){c.destroyLock(a);delete e[a]}};g.cq=new function(){};for(f in d)d.hasOwnProperty(f)&&(g.cq[f]=d[f])})(this);